    ...
    return (
        <>
            <div data-v-154c538c="" className="form-group mb-3">
                ...
                <div className='input'>
                    <input onChange={event => handleChange({ ...formData, ios: { ...formData.android, primary: event.target.value } })} data-v-154c538c="" placeholder='primary' id="long-url" type="text" aria-label="Long URL" required={currentAction === 'add' ? "required" : undefined} className="enterurl form-control form-control-lg form-control-fancy text-t-green" />
                    <input onChange={event => handleChange({ ...formData, ios: { ...formData.android, fallback: event.target.value } })} data-v-154c538c="" placeholder='fallback' id="long-url" type="text" aria-label="Long URL" required={currentAction === 'add' ? "required" : undefined} className="enterurl form-control form-control-lg form-control-fancy text-t-green" />
                </div>
            ...
            <label data-v-154c538c="" htmlFor="domain" className="homeFormTiny__cust-title mb-0">
                ...
                <div data-v-154c538c="" className="col-12 col-md-5 pl-md-0 pt-1">
                    ...
                    <input onChange={event => handleChange({ ...formData, slug: event.target.value })} data-v-154c538c="" aria-label="Alias" type="text" placeholder="slug" className="alias-input form-control text-t-green" />
